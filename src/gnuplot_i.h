...
class GnuplotS
{
    ...
    public:
        ...
        GnuplotS(const std::string &style = "points");

        /// plot a single std::vector at one go
        GnuplotS(const std::vector<double> &x,
    ...
    /// send a command to gnuplot
        GnuplotS& cmd(const std::string &cmdstr);
	// ---------------------------------------------------------------------------------
	...
	// ---------------------------------------------------------------------------------
    inline GnuplotS& operator<<(const std::string &cmdstr){
        cmd(cmdstr);
        return(*this);
    }
    ...
    inline GnuplotS& showonscreen(); // window output is set by default (win/x11/aqua)

    /// saves a gnuplot session to a postscript file, filename without extension
    GnuplotS& savetops(const std::string &filename = "gnuplot_output");
    ...
    GnuplotS& set_style(const std::string &stylestr = "points");
    ...
    GnuplotS& set_smooth(const std::string &stylestr = "csplines");
    ...
    // ----------------------------------------------------------------------
    inline GnuplotS& unset_smooth(){ smooth = ""; return *this;};


    /// scales the size of the points used in plots
    GnuplotS& set_pointsize(const double pointsize = 1.0);

    /// turns grid on/off
    inline GnuplotS& set_grid()	{cmd("set grid");return *this;};
    /// grid is not set by default	
    inline GnuplotS& unset_grid(){cmd("unset grid");return *this;};
    ...
    // -----------------------------------------------
    inline GnuplotS& set_multiplot(){cmd("set multiplot") ;return *this;};
    ...
    /// \return <-- reference to the gnuplot object
    // -----------------------------------------------
    inline GnuplotS& unset_multiplot(){cmd("unset multiplot");return *this;};
    


    /// set sampling rate of functions, or for interpolating data
    GnuplotS& set_samples(const int samples = 100);
    /// set isoline density (grid) for plotting functions as surfaces (for 3d plots)
    GnuplotS& set_isosamples(const int isolines = 10);
    ...
    /// \return <-- reference to the gnuplot object
    // --------------------------------------------------------------------------
    GnuplotS& set_hidden3d(){cmd("set hidden3d");return *this;};
    ...
    /// \return <-- reference to the gnuplot object
    // ---------------------------------------------------------------------------
    inline GnuplotS& unset_hidden3d(){cmd("unset hidden3d"); return *this;};

    /// enables/disables contour drawing for surfaces (for 3d plot)
    ///  base, surface, both
    GnuplotS& set_contour(const std::string &position = "base");
    // --------------------------------------------------------------------------
    ...
    /// \return <-- reference to the gnuplot object
    // ------------------------------------------------------------------
    inline GnuplotS& unset_contour(){cmd("unset contour");return *this;};
    ...
    /// \return <-- reference to the gnuplot object
    // ------------------------------------------------------------------
    inline GnuplotS& set_surface(){cmd("set surface");return *this;};
    ...
    /// \return <-- reference to the gnuplot object
    // ------------------------------------------------------------------
    inline GnuplotS& unset_surface(){cmd("unset surface"); return *this;}


    /// switches legend on/off
    /// position: inside/outside, left/center/right, top/center/bottom, nobox/box
    GnuplotS& set_legend(const std::string &position = "default");
    ...
    /// \return <-- reference to the gnuplot object
    // ------------------------------------------------------------------
    inline GnuplotS& unset_legend(){cmd("unset key"); return *this;}
    ...
    /// \return <-- reference to the gnuplot object
    // ----------------------------------------------------------------------- 
    inline GnuplotS& set_title(const std::string &title = "")
    {
        std::string cmdstr;
        cmdstr = "set title \"";
        cmdstr+=title;
    ...
    /// \return <-- reference to the gnuplot object
    // ---------------------------------------------------------------------------------
    inline GnuplotS& unset_title(){this->set_title();return *this;}


    /// set x axis label
    GnuplotS& set_ylabel(const std::string &label = "x");
    /// set y axis label
    GnuplotS& set_xlabel(const std::string &label = "y");
    /// set z axis label
    GnuplotS& set_zlabel(const std::string &label = "z");

    /// set axis - ranges
    GnuplotS& set_xrange(const double iFrom,
                        const double iTo);
    /// set y-axis - ranges
    GnuplotS& set_yrange(const double iFrom,
                        const double iTo);
    /// set z-axis - ranges
    GnuplotS& set_zrange(const double iFrom,
                        const double iTo);
    ...
    /// \return <-- reference to the gnuplot object
    // -----------------------------------------------
    inline GnuplotS& set_xautoscale(){cmd("set xrange restore");cmd("set autoscale x");return *this;};
    ...
    /// \return <-- reference to the gnuplot object
    // -----------------------------------------------
    inline GnuplotS& set_yautoscale(){cmd("set yrange restore");cmd("set autoscale y");return *this;};
    ...
    /// \return <-- reference to the gnuplot object
    // -----------------------------------------------	
    inline GnuplotS& unset_xlogscale(){cmd("unset logscale x"); return *this;};
    ...
    /// \return <-- reference to the gnuplot object
    // -----------------------------------------------	
    inline GnuplotS& unset_ylogscale(){cmd("unset logscale y"); return *this;};
    ...
    /// \return <-- reference to the gnuplot object
    // -----------------------------------------------		
    inline GnuplotS& unset_zlogscale(){cmd("unset logscale z"); return *this;};


    /// set palette range (autoscale by default)
    GnuplotS& set_cbrange(const double iFrom, const double iTo);
    ...
    ///   from file
    GnuplotS& plotfile_x(const std::string &filename,
                        const unsigned int column = 1,
                        const std::string &title = "");
    ///   from std::vector
    template<typename X>
    GnuplotS& plot_x(const X& x, const std::string &title = "");


    /// plot x,y pairs: x y
    ///   from file
    GnuplotS& plotfile_xy(const std::string &filename,
                         const unsigned int column_x = 1,
                         const unsigned int column_y = 2,
                         const std::string &title = "");
    ///   from data
    template<typename X, typename Y>
    GnuplotS& plot_xy(const X& x, const Y& y, const std::string &title = "");


    /// plot x,y pairs with dy errorbars: x y dy
    ///   from file
    GnuplotS& plotfile_xy_err(const std::string &filename,
                             const unsigned int column_x  = 1,
                             const unsigned int column_y  = 2,
    ...
    GnuplotS& plot_xy_err(const X &x, const Y &y, const E &dy,
                         const std::string &title = "");


    /// plot x,y,z triples: x y z
    ///   from file
    GnuplotS& plotfile_xyz(const std::string &filename,
                          const unsigned int column_x = 1,
                          const unsigned int column_y = 2,
    ...
    GnuplotS& plot_slope(const double a,
                        const double b,
                        const std::string &title = "");
    ...
    GnuplotS& plot_equation(const std::string &equation,
                           const std::string &title = "");
    ...
    GnuplotS& plot_equation3d(const std::string &equation,
                             const std::string &title = "");


    /// plot image
    GnuplotS& plot_image(const unsigned char *ucPicBuf,
    ...
    /// \return ---
    //----------------------------------------------------------------------------------
    inline GnuplotS& replot(void){if (nplots > 0) cmd("replot");return *this;};
...
//
inline int GnuplotS::tmpfile_num = 0;

#if defined(WIN32) || defined(_WIN32) || defined(__WIN32__) || defined(__TOS_WIN__)
inline std::string GnuplotS::m_sGNUPlotFileName = "pgnuplot.exe";
inline std::string GnuplotS::m_sGNUPlotPath = "C:/program files/gnuplot/bin/";
#elif defined(unix) || defined(__unix) || defined(__unix__) || defined(__APPLE__)
inline std::string GnuplotS::m_sGNUPlotFileName = "gnuplot";
inline std::string GnuplotS::m_sGNUPlotPath = "/usr/local/bin/";
#endif

#if defined(WIN32) || defined(_WIN32) || defined(__WIN32__) || defined(__TOS_WIN__)
inline std::string GnuplotS::terminal_std = "windows";
#elif ( defined(unix) || defined(__unix) || defined(__unix__) ) && !defined(__APPLE__)
inline std::string GnuplotS::terminal_std = "x11";
#elif defined(__APPLE__)
inline std::string GnuplotS::terminal_std = "aqua";
#endif
...
//
inline GnuplotS::GnuplotS(const std::string &style)
...
//
inline GnuplotS::GnuplotS(const std::vector<double> &x,
                 const std::string &title,
...
//
template<typename X>
GnuplotS& GnuplotS::plot_x(const X& x, const std::string &title)
{
    if (x.size() == 0)
    {
...
//
template<typename X, typename Y>
GnuplotS& GnuplotS::plot_xy(const X& x, const Y& y, const std::string &title)
{
...
///
template<typename X, typename Y, typename E>
GnuplotS& GnuplotS::plot_xy_err(const X &x,
                              const Y &y,
                              const E &dy,
                              const std::string &title)
{
...
//
template<typename X, typename Y, typename Z>
GnuplotS& GnuplotS::plot_xyz(const X &x,
                           const Y &y,
                           const Z &z,
                           const std::string &title)
{
...
//
inline bool GnuplotS::set_GNUPlotPath(const std::string &path)
{

    std::string tmp = path + "/" + GnuplotS::m_sGNUPlotFileName;


#if defined(WIN32) || defined(_WIN32) || defined(__WIN32__) || defined(__TOS_WIN__)
    if ( GnuplotS::file_exists(tmp,0) ) // check existence
#elif defined(unix) || defined(__unix) || defined(__unix__) || defined(__APPLE__)
    if ( GnuplotS::file_exists(tmp,1) ) // check existence and execution permission
#endif
    {
        GnuplotS::m_sGNUPlotPath = path;
        return true;
    }
    else
    {
        GnuplotS::m_sGNUPlotPath.clear();
        return false;
    }
}
...
//  defaults: Windows - win, Linux - x11, Mac - aqua
//
inline void GnuplotS::set_terminal_std(const std::string &type)
{
...
// Resets a gnuplot session (next plot will erase previous ones)
//
inline GnuplotS& GnuplotS::reset_plot()
{
//  remove_tmpfiles();
...
//
inline GnuplotS& GnuplotS::reset_all()
{
//  remove_tmpfiles();
...
//
inline GnuplotS& GnuplotS::set_style(const std::string &stylestr)
{
...
//
inline GnuplotS& GnuplotS::set_smooth(const std::string &stylestr)
{
...
//
GnuplotS& GnuplotS::showonscreen()
{
    cmd("set output");
    cmd("set terminal " + GnuplotS::terminal_std);
...
//
inline GnuplotS& GnuplotS::savetops(const std::string &filename)
{
...
// Switches legend on
//
inline GnuplotS& GnuplotS::set_legend(const std::string &position)
{
    std::ostringstream cmdstr;
...
//
inline GnuplotS& GnuplotS::set_xlogscale(const double base)
{
    std::ostringstream cmdstr;
...
//
inline GnuplotS& GnuplotS::set_ylogscale(const double base)
{
    std::ostringstream cmdstr;
...
//
inline GnuplotS& GnuplotS::set_zlogscale(const double base)
{
    std::ostringstream cmdstr;
...
// scales the size of the points used in plots
//
inline GnuplotS& GnuplotS::set_pointsize(const double pointsize)
{
    std::ostringstream cmdstr;
...
//
inline GnuplotS& GnuplotS::set_samples(const int samples)
{
    std::ostringstream cmdstr;
...
// set isoline density (grid) for plotting functions as surfaces
//
inline GnuplotS& GnuplotS::set_isosamples(const int isolines)
{
    std::ostringstream cmdstr;
...
inline GnuplotS& GnuplotS::set_contour(const std::string &position)
{
...
//
// set the xlabel
inline GnuplotS& GnuplotS::set_xlabel(const std::string &label)
{
    std::ostringstream cmdstr;
...
// set the ylabel
//
inline GnuplotS& GnuplotS::set_ylabel(const std::string &label)
{
    std::ostringstream cmdstr;
...
// set the zlabel
//
inline GnuplotS& GnuplotS::set_zlabel(const std::string &label)
{
    std::ostringstream cmdstr;
...
//
// set the xrange
inline GnuplotS& GnuplotS::set_xrange(const double iFrom,
                             const double iTo)
{
    std::ostringstream cmdstr;
...
// set the yrange
//
inline GnuplotS& GnuplotS::set_yrange(const double iFrom,
                             const double iTo)
{
    std::ostringstream cmdstr;
...
// set the zrange
//
inline GnuplotS& GnuplotS::set_zrange(const double iFrom,
                             const double iTo)
{
    std::ostringstream cmdstr;
...
//
inline GnuplotS& GnuplotS::set_cbrange(const double iFrom,
                              const double iTo)
{
    std::ostringstream cmdstr;
...
//
inline GnuplotS& GnuplotS::plot_slope(const double a,
                             const double b,
                             const std::string &title)
{
    std::ostringstream cmdstr;
    //
    // command to be sent to GnuplotS
    //
...
//
inline GnuplotS& GnuplotS::plot_equation(const std::string &equation,
                                const std::string &title)
{
    std::ostringstream cmdstr;
    //
...
//
inline GnuplotS& GnuplotS::plot_equation3d(const std::string &equation,
                                  const std::string &title)
{
    std::ostringstream cmdstr;
    //
...
//
inline GnuplotS& GnuplotS::plotfile_x(const std::string &filename,
...
//
inline GnuplotS& GnuplotS::plotfile_xy(const std::string &filename,
...
//
inline GnuplotS& GnuplotS::plotfile_xy_err(const std::string &filename,
                                  const unsigned int column_x,
                                  const unsigned int column_y,
...
//
inline GnuplotS& GnuplotS::plotfile_xyz(const std::string &filename,
                               const unsigned int column_x,
                               const unsigned int column_y,
...
//
inline GnuplotS& GnuplotS::plot_image(const unsigned char * ucPicBuf,
                             const unsigned int iWidth,
                             const unsigned int iHeight,
                             const std::string &title)
{
...
//
inline GnuplotS& GnuplotS::cmd(const std::string &cmdstr)
{
    if( !(valid) )
    {
        return *this;
...
inline void GnuplotS::init()
{
    ...
    // open pipe
    //
    std::string tmp = GnuplotS::m_sGNUPlotPath + "/" +
        GnuplotS::m_sGNUPlotFileName;
...
//
inline bool GnuplotS::get_program_path()
{
    //
    ...
    else
    {
        ...
        for (std::list<std::string>::const_iterator i = ls.begin(); 
                i != ls.end(); ++i)
        {
            tmp = (*i) + "/" + GnuplotS::m_sGNUPlotFileName;
#if defined(WIN32) || defined(_WIN32) || defined(__WIN32__) || defined(__TOS_WIN__)
            if ( GnuplotS::file_exists(tmp,0) ) // check existence
#elif defined(unix) || defined(__unix) || defined(__unix__) || defined(__APPLE__)
            if ( GnuplotS::file_exists(tmp,1) ) // check existence and execution permission
#endif
            {
                GnuplotS::m_sGNUPlotPath = *i; // set m_sGNUPlotPath
                return true;
            }
        }

        tmp = "Can't find gnuplot neither in PATH nor in \"" + 
            GnuplotS::m_sGNUPlotPath + "\"";
...
// check if file exists
//
inline bool GnuplotS::file_exists(const std::string &filename, int mode)
{
    if ( mode < 0 || mode > 7)
    {
...
inline bool GnuplotS::file_available(const std::string &filename){
    std::ostringstream except;
    if( GnuplotS::file_exists(filename,0) ) // check existence
    {
        if( !(GnuplotS::file_exists(filename,4)) ){// check read permission
...
//
inline std::string GnuplotS::create_tmpfile(std::ofstream &tmp)
{
    ...
    //
    if (GnuplotS::tmpfile_num == GP_MAX_TMP_FILES - 1)
    {
        std::ostringstream except;
    ...
    GnuplotS::tmpfile_num++;

    return name;
}

inline void GnuplotS::remove_tmpfiles(){
    if ((tmpfile_list).size() > 0)
    {
        for (unsigned int i = 0; i < tmpfile_list.size(); i++)
            remove( tmpfile_list[i].c_str() );

        GnuplotS::tmpfile_num -= tmpfile_list.size();
    }
}
#endif
